...
const couchPotatoMainSiteUser = mongoose.model("main-site-user", MainSiteUserSchema);
const circuitronMainSiteUser=conn.circuitron.model("main-site-user",MainSiteUserSchema);
